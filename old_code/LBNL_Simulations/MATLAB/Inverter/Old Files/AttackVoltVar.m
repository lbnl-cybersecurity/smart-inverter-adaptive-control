...
% Date : 05/22/2018
% This code is the modified version of the original code written by Dan Arnold
% Variables Clarified and Structured
clc;
clear;
close all;
...
for ksim=1:TotalTimeSteps
   ...
   PowerEachTimeStep_nc(knode,:) = [ZIP_demand(ksim,knode,1) - SolarGeneration_NC(ksim,knode),...
